...
<script type="text/javascript" charset="utf-8" async="" data-requirecontext="_" data-requiremodule="vs/editor/editor.main" src="INNER_JOIN._files/editor.main.js"></script><script type="text/javascript" charset="utf-8" async="" data-requirecontext="_" data-requiremodule="ojtranslations/nls/localeElements" src="INNER_JOIN._files/localeElements.js"></script><script type="text/javascript" charset="utf-8" async="" data-requirecontext="_" data-requiremodule="ojtranslations/nls/en/localeElements" src="INNER_JOIN._files/localeElements_002.js"></script><script type="text/javascript" charset="utf-8" async="" data-requirecontext="_" data-requiremodule="custom-languages/sql.min" src="INNER_JOIN._files/sql.min.js"></script><!-- base href="https://oracleapex.com/ords/" -->
<link rel="stylesheet" href="INNER_JOIN._files/Core.min_002.css" type="text/css">
<link rel="stylesheet" href="INNER_JOIN._files/Theme-Standard.min.css" type="text/css">

<link rel="stylesheet" href="INNER_JOIN._files/oraclesans-apex.min.css" type="text/css">


<link rel="stylesheet" href="INNER_JOIN._files/Core.min.css" type="text/css">
<link rel="stylesheet" href="INNER_JOIN._files/Theme-Dark.min.css" type="text/css">

<link rel="stylesheet" href="INNER_JOIN._files/apex_builder.min.css" type="text/css">

<style nonce="r6_BQzI3TkQRCQ8_WX9JMg">
#htmlTabHolder 
{
    overflow: auto; 
}
...
<style type="text/css">.LayerStyles_baseStyle__g9p4b90{position:relative}.LayerStyles_popupPriorityStyle__g9p4b91{z-index:1000}.LayerStyles_dialogPriorityStyle__g9p4b92{z-index:1050}.LayerStyles_messagesPriorityStyle__g9p4b93{z-index:2000}</style><script type="text/javascript" src="INNER_JOIN._files/common.js" async="true" defer="true"></script><script type="text/javascript" src="INNER_JOIN._files/analytics.js" async="true" defer="true"></script><link rel="stylesheet" type="text/css" data-name="vs/editor/editor.main" href="INNER_JOIN._files/editor.main.css"><style type="text/css" media="screen" class="monaco-colors">.codicon-add:before { content: '\ea60'; }
...
<input type="hidden" name="p_flow_id" value="4500" id="pFlowId"><input type="hidden" name="p_flow_step_id" value="1003" id="pFlowStepId"><input type="hidden" name="p_instance" value="101812520739103" id="pInstance"><input type="hidden" name="p_page_submission_id" value="MjU3NTI0NTM4Njg1OTUwMzc2OTU1NzgyMTIxNDYyNjUwMDM5OTgy/WfgfBQlL7GTvjVO6tzQULSDopbd9wPQ3RA0xg4gmhQIwjIOltjKGbpinEAqZeuAHgb_MAJpFjnH5ZqidM3FYaQ" id="pPageSubmissionId"><input type="hidden" name="p_request" value="" id="pRequest"><input type="hidden" name="p_reload_on_submit" value="A" id="pReloadOnSubmit"><input type="hidden" value="sql-workshop/sqlcommandprocessor/101812520739103" id="pContext"><input type="hidden" value="257524538685950376955782121462650039982" id="pSalt"><script> 
...
<span id="APEX_SUCCESS_MESSAGE" data-template-id="690783685471803190_S" class="apex-page-success u-hidden"></span><span id="APEX_ERROR_MESSAGE" data-template-id="690783685471803190_E" class="apex-page-error u-hidden"></span><script src="INNER_JOIN._files/odc.js"></script>
<script>
// Send Data
var cxDataObject = {
"apex.version":"24.2",
...
<div class="a-Form-fieldContainer  apex-item-wrapper plugin-com.oracle.apex.code-language has-helpbutton" id="P1003_CMD_LANGUAGE_CONTAINER"><div class="a-Form-labelContainer">
...
</div><div class="a-Form-inputContainer"><div id="P1003_SQL_COMMAND1_widget" style="height: 100%;" class="a-MonacoEditor is-active"><textarea id="P1003_SQL_COMMAND1" name="P1003_SQL_COMMAND1" rows="5" class="a-Form-textarea--code" style="display: none;">// performing inner join
CREATE TABLE DEMO1(
...
INSERT INTO DEMO2 VALUES(101,'AMIT');
INSERT INTO DEMO2 VALUES(102,'BOB');
INSERT INTO DEMO2 VALUES(103,'ALICE');
...
ON DEMO1.STUDENT_ID = DEMO2.EMPLOYEE_ID;
                    ...
                    <div class="a-MonacoEditorContent-left">
                        ...
                        <div class="a-MonacoEditor-editor" dir="ltr" data-keybinding-context="1" data-mode-id="sql" style="--vscode-editorCodeLens-lineHeight: 19px; --vscode-editorCodeLens-fontSize: 15px; --vscode-editorCodeLens-fontFeatureSettings: &quot;liga&quot; off, &quot;calt&quot; off;"><div class="monaco-editor no-user-select  showUnused showDeprecated vs-dark focused" role="code" style="width: 1918px; height: 475px;" data-uri="inmemory://model/1"><div data-mprt="3" class="overflow-guard" style="width: 1918px; height: 475px;"><div class="margin" style="position: absolute; transform: translate3d(0px, 0px, 0px); contain: strict; top: -400px; height: 1179px; width: 63px;" role="presentation" aria-hidden="true"><div class="glyph-margin" style="left: 0px; width: 0px; height: 1179px;"></div><div class="margin-view-zones" style="position: absolute;" role="presentation" aria-hidden="true"></div><div class="margin-view-overlays focused" style="position: absolute; font-family: Consolas, &quot;Courier New&quot;, monospace; font-weight: normal; font-size: 16.8px; font-feature-settings: &quot;liga&quot; 0, &quot;calt&quot; 0; font-variation-settings: normal; line-height: 22px; letter-spacing: 0px; width: 63px; height: 1179px;" role="presentation" aria-hidden="true"><div style="top:682px;height:22px;"><div class="line-numbers" style="left:0px;width:37px;">32</div></div><div style="top:704px;height:22px;"><div class="line-numbers" style="left:0px;width:37px;">33</div></div><div style="top:638px;height:22px;"><div class="line-numbers" style="left:0px;width:37px;">30</div></div><div style="top:660px;height:22px;"><div class="line-numbers" style="left:0px;width:37px;">31</div></div><div style="top:594px;height:22px;"><div class="line-numbers" style="left:0px;width:37px;">28</div></div><div style="top:616px;height:22px;"><div class="line-numbers" style="left:0px;width:37px;">29</div></div><div style="top:550px;height:22px;"><div class="line-numbers" style="left:0px;width:37px;">26</div></div><div style="top:572px;height:22px;"><div class="line-numbers" style="left:0px;width:37px;">27</div></div><div style="top:484px;height:22px;"><div class="line-numbers" style="left:0px;width:37px;">23</div></div><div style="top:506px;height:22px;"><div class="line-numbers" style="left:0px;width:37px;">24</div></div><div style="top:528px;height:22px;"><div class="line-numbers" style="left:0px;width:37px;">25</div></div><div style="top:440px;height:22px;"><div class="line-numbers" style="left:0px;width:37px;">21</div></div><div style="top:462px;height:22px;"><div class="line-numbers" style="left:0px;width:37px;">22</div></div><div style="top:396px;height:22px;"><div class="line-numbers" style="left:0px;width:37px;">19</div></div><div style="top:418px;height:22px;"><div class="current-line current-line-margin-both" style="width:63px"></div><div class="line-numbers active-line-number" style="left:0px;width:37px;">20</div></div></div><div class="glyph-margin-widgets" style="position: absolute; top: 0px;"></div></div><div class="monaco-scrollable-element editor-scrollable vs-dark" role="presentation" style="position: absolute; overflow: hidden; left: 63px; width: 1855px; height: 475px;" data-mprt="6"><div class="lines-content monaco-editor-background" style="position: absolute; overflow: hidden; width: 16777200px; height: 16777200px; transform: translate3d(0px, 0px, 0px); contain: strict; top: -400px; left: 0px;"><div class="view-overlays focused" style="position: absolute; font-family: Consolas, &quot;Courier New&quot;, monospace; font-weight: normal; font-size: 16.8px; font-feature-settings: &quot;liga&quot; 0, &quot;calt&quot; 0; font-variation-settings: normal; line-height: 22px; letter-spacing: 0px; height: 0px; width: 1855px;" role="presentation" aria-hidden="true"><div style="top:682px;height:22px;"></div><div style="top:704px;height:22px;"></div><div style="top:638px;height:22px;"></div><div style="top:660px;height:22px;"></div><div style="top:594px;height:22px;"></div><div style="top:616px;height:22px;"></div><div style="top:550px;height:22px;"></div><div style="top:572px;height:22px;"></div><div style="top:484px;height:22px;"></div><div style="top:506px;height:22px;"></div><div style="top:528px;height:22px;"></div><div style="top:440px;height:22px;"></div><div style="top:462px;height:22px;"></div><div style="top:396px;height:22px;"></div><div style="top:418px;height:22px;"><div class="current-line current-line-exact" style="width:1855px;"></div></div></div><div role="presentation" aria-hidden="true" class="view-rulers"></div><div class="view-zones" style="position: absolute;" role="presentation" aria-hidden="true"></div><div class="view-lines monaco-mouse-cursor-text" style="position: absolute; font-family: Consolas, &quot;Courier New&quot;, monospace; font-weight: normal; font-size: 16.8px; font-feature-settings: &quot;liga&quot; 0, &quot;calt&quot; 0; font-variation-settings: normal; line-height: 22px; letter-spacing: 0px; width: 1855px; height: 1179px;" role="presentation" aria-hidden="true" data-mprt="8"><div style="top:682px;height:22px;" class="view-line"><span><span class="mtk15">ON</span><span class="mtk1">&nbsp;DEMO1</span><span class="mtk10">.</span><span class="mtk1">STUDENT_ID&nbsp;=&nbsp;DEMO2</span><span class="mtk10">.</span><span class="mtk1">EMPLOYEE_ID</span><span class="mtk10">;</span></span></div><div style="top:704px;height:22px;" class="view-line"><span><span></span></span></div><div style="top:638px;height:22px;" class="view-line"><span><span class="mtk15">FROM</span><span class="mtk1">&nbsp;DEMO1</span></span></div><div style="top:660px;height:22px;" class="view-line"><span><span class="mtk15">INNER</span><span class="mtk1">&nbsp;</span><span class="mtk15">JOIN</span><span class="mtk1">&nbsp;DEMO2</span></span></div><div style="top:594px;height:22px;" class="view-line"><span><span></span></span></div><div style="top:616px;height:22px;" class="view-line"><span><span class="mtk15">SELECT</span><span class="mtk1">&nbsp;*</span></span></div><div style="top:550px;height:22px;" class="view-line"><span><span class="mtk15">RENAME</span><span class="mtk1">&nbsp;</span><span class="mtk15">COLUMN</span><span class="mtk1">&nbsp;</span><span class="mtk15">ID</span><span class="mtk1">&nbsp;</span><span class="mtk15">TO</span><span class="mtk1">&nbsp;STUDENT_ID</span><span class="mtk10">;</span></span></div><div style="top:572px;height:22px;" class="view-line"><span><span></span></span></div><div style="top:484px;height:22px;" class="view-line"><span><span></span></span></div><div style="top:506px;height:22px;" class="view-line"><span><span></span></span></div><div style="top:528px;height:22px;" class="view-line"><span><span class="mtk15">ALTER</span><span class="mtk1">&nbsp;</span><span class="mtk15">TABLE</span><span class="mtk1">&nbsp;DEMO1&nbsp;</span></span></div><div style="top:440px;height:22px;" class="view-line"><span><span class="mtk15">SELECT</span><span class="mtk1">*</span><span class="mtk15">FROM</span><span class="mtk1">&nbsp;DEMO2</span></span></div><div style="top:462px;height:22px;" class="view-line"><span><span class="mtk15">ORDER</span><span class="mtk1">&nbsp;</span><span class="mtk15">BY</span><span class="mtk1">&nbsp;EMPLOYEE_ID&nbsp;</span><span class="mtk15">ASC</span><span class="mtk10">;</span></span></div><div style="top:396px;height:22px;" class="view-line"><span><span class="mtk15">WHERE</span><span class="mtk1">&nbsp;EMPLOYEE_ID=</span><span class="mtk7">103</span><span class="mtk10">;</span></span></div><div style="top:418px;height:22px;" class="view-line"><span><span></span></span></div></div><div data-mprt="1" class="contentWidgets" style="position: absolute; top: 0px;"></div><div role="presentation" aria-hidden="true" class="cursors-layer cursor-line-style cursor-solid"><div class="cursor  monaco-mouse-cursor-text " style="height: 22px; top: 418px; left: 0px; font-family: Consolas, &quot;Courier New&quot;, monospace; font-weight: normal; font-size: 16.8px; font-feature-settings: &quot;liga&quot; 0, &quot;calt&quot; 0; font-variation-settings: normal; line-height: 22px; letter-spacing: 0px; display: block; visibility: inherit; padding-left: 0px; width: 2px;"></div></div></div><div role="presentation" aria-hidden="true" class="invisible scrollbar horizontal" style="position: absolute; width: 1841px; height: 12px; left: 0px; bottom: 0px;"><div class="slider" style="position: absolute; top: 0px; left: 0px; height: 12px; transform: translate3d(0px, 0px, 0px); contain: strict; width: 1841px;"></div></div><canvas class="decorationsOverviewRuler" style="position: absolute; transform: translate3d(0px, 0px, 0px); contain: strict; top: 0px; right: 0px; width: 14px; height: 475px; display: block;" aria-hidden="true" width="14" height="475"></canvas><div role="presentation" aria-hidden="true" class="invisible scrollbar vertical fade" style="position: absolute; width: 14px; height: 475px; right: 0px; top: 0px;"><div class="slider" style="position: absolute; top: 161px; left: 0px; width: 14px; transform: translate3d(0px, 0px, 0px); contain: strict; height: 191px;"></div></div></div><div role="presentation" aria-hidden="true" style="width: 1918px;" class="scroll-decoration"></div><textarea data-mprt="7" class="inputarea monaco-mouse-cursor-text" wrap="off" style="tab-size: 36.9375px; font-family: Consolas, &quot;Courier New&quot;, monospace; font-weight: normal; font-size: 16.8px; font-feature-settings: &quot;liga&quot; 0, &quot;calt&quot; 0; font-variation-settings: normal; line-height: 22px; letter-spacing: 0px; top: 18px; left: 63px; width: 0px; height: 22px;" autocorrect="off" autocapitalize="none" autocomplete="off" spellcheck="false" aria-label="SQL Command" aria-required="false" tabindex="0" role="textbox" aria-roledescription="editor" aria-multiline="true" aria-autocomplete="both" aria-readonly="false">// performing inner join
CREATE TABLE DEMO1(
    ID NUMBER PRIMARY KEY,
    NAME VARCHAR(50)
);
...
<tbody><tr><th id="STUDENT_ID">STUDENT_ID</th><th id="NAME">NAME</th><th id="EMPLOYEE_ID">EMPLOYEE_ID</th><th id="EMPLOYEE_NAME">EMPLOYEE_NAME</th></tr>
<tr><td headers="STUDENT_ID">101</td><td headers="NAME">ANIL</td><td headers="EMPLOYEE_ID">101</td><td headers="EMPLOYEE_NAME">AMIT</td></tr>
<tr><td headers="STUDENT_ID">102</td><td headers="NAME">AMAR</td><td headers="EMPLOYEE_ID">102</td><td headers="EMPLOYEE_NAME">BOB</td></tr>
</tbody></table>
</div>
<table><tbody><tr><td><span style="font-size:13px">2 rows returned in                0.02 seconds</span></td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><span style="font-size:11px"><a href="https://oracleapex.com/ords/f?p=4500:1204:101812520739103::::P1204_BROWSER_LANG:en">Download</a></span></td></tr></tbody></table><div class="hide-show-region" id="dbms_output_show_hide" style="display:none;">
  <div class="hide-show-top">
    <div class="hide-show-title"><h3 data-apex-heading="">
      <a href="#" onclick="htmldb_ToggleTableBody('idbms_output_show_hide','bodydbms_output_show_hide'); return false;">
        <img src="INNER_JOIN._files/rollup_plus_dgray.gif" class="pseudoButtonActive" id="idbms_output_show_hide" alt="">
        DBMS Output
      </a></h3>    
    </div>
  </div>
  <div class="hide-show-body" style="display:none;" id="bodydbms_output_show_hide"><div id="DBMS_OUTPUT_DIV"></div></div>
</div></div></div><div id="explainHolder" style="display: none;"><div id="BOX_BODY"><div class="a-Alert a-Alert--defaultIcons a-Alert--warning a-Alert--wizard" id="R2219893965597640" role="region" aria-labelledby="R2219893965597640_TITLE">
  <div class="a-Alert-wrap">
    ...
    <div class="a-Alert-content">
      <div class="a-Alert-header">
        <h2 id="R2219893965597640_TITLE" class="a-Alert-title" data-apex-heading="">Statement not supported</h2>
      </div>
      <div role="alert" class="a-Alert-body">This statement is not supported for explain plan.</div>
    </div>
    <div class="a-Alert-buttons"></div>
  </div>
</div><div id="R11140505307196687" class=""><input type="hidden" name="OB_OBJECT_NAME" id="OB_OBJECT_NAME" value=""><input type="hidden" name="P0_PPRTIMESTAMP" id="P0_PPRTIMESTAMP" value=""></div></div></div><div id="describeHolder" style="display: none;"><div id="BOX_BODY"><table id="apex_layout_22151631482530337" border="0" class="formlayout" role="presentation"><tbody><tr><td nowrap="nowrap" align="right"><div class="a-Form-labelContainer">
<label for="P139_TYPE" id="P139_TYPE_LABEL" class="a-Form-label">Object Type</label>
</div></td><td align="left"><div class="a-Form-inputContainer"><input type="hidden" id="P139_TYPE" name="P139_TYPE" value="TABLE"><input type="hidden" data-for="P139_TYPE" value="JqXLhnjDMdxmFX29qWJbznzPYdVabsUPpww63hKRBXobJ3NRj25R-WGlPFtZB9iP1iSwHlcwO9t-iWeRknkRqA"><span id="P139_TYPE_DISPLAY" class="display_only apex-item-display-only fielddatabold" data-escape="true">TABLE</span><button class="a-Button a-Button--noUI a-Button--helpButton js-itemHelp" data-itemhelp="22156222310565561" title="View help text for Object Type." aria-label="View help text for Object Type." tabindex="-1" type="button"><span class="a-Icon icon-help" aria-hidden="true"></span></button><span id="P139_TYPE_error_placeholder" class="a-Form-error" data-template-id="488671029226029669_ET"></span></div></td><td nowrap="nowrap" align="right"><div class="a-Form-labelContainer">
<label for="P139_OBJECT" id="P139_OBJECT_LABEL" class="a-Form-label">Object</label>
</div></td><td align="left"><div class="a-Form-inputContainer"><input type="hidden" id="P139_OBJECT" name="P139_OBJECT" value="DEMO1"><input type="hidden" data-for="P139_OBJECT" value="XMHsP4b9C3tNuO8YX4xtsNLBL_6DwU0MsCFywnmZi3rrwVvPJWAGcZJVmO-XsTfMwHwP8SjfU0QKo-Loihp-1w"><span id="P139_OBJECT_DISPLAY" class="display_only apex-item-display-only fielddatabold" data-escape="true">DEMO1</span><button class="a-Button a-Button--noUI a-Button--helpButton js-itemHelp" data-itemhelp="22174606305655533" title="View help text for Object." aria-label="View help text for Object." tabindex="-1" type="button"><span class="a-Icon icon-help" aria-hidden="true"></span></button><span id="P139_OBJECT_error_placeholder" class="a-Form-error" data-template-id="488671029226029669_ET"></span></div><input type="hidden" name="P139_STATUS" id="P139_STATUS" value="VALID"><input type="hidden" name="P139_OWNER" id="P139_OWNER" value="WKSP_HARSHJTHAKAR"><input type="hidden" name="P139_ACTION" id="P139_ACTION" value="GET"><input type="hidden" name="P139_PREV_SQL" id="P139_PREV_SQL" value="SELECT *
FROM DEMO1
INNER JOIN DEMO2
ON DEMO1.ID = DEMO2.EMPLOYEE_ID;"></td></tr></tbody></table><div id="R11140505307196687" class=""><input type="hidden" name="OB_OBJECT_NAME" id="OB_OBJECT_NAME" value=""><input type="hidden" name="P0_PPRTIMESTAMP" id="P0_PPRTIMESTAMP" value=""></div><div class="a-Report " id="report_R367602808298431816">
  <div class="a-Report-wrap">
    <table class="a-Report-pagination" role="presentation"><tbody><tr><td></td></tr></tbody></table>
    <div class="a-Report-tableWrap">
    <table class="a-Report-report" aria-label="Tables and Views">
<thead><tr><th class="a-Report-colHead" align="center" id="TABLE_NAME">Table</th><th class="a-Report-colHead" align="center" id="COLUMN_NAME">Column</th><th class="a-Report-colHead" align="center" id="DATA_TYPE">Data Type</th><th class="a-Report-colHead" align="center" id="DATA_LENGTH">Length</th><th class="a-Report-colHead" align="center" id="DATA_PRECISION">Precision</th><th class="a-Report-colHead" align="center" id="DATA_SCALE">Scale</th><th class="a-Report-colHead" align="center" id="PK">Primary Key</th><th class="a-Report-colHead" align="center" id="NULLABLE">Nullable</th><th class="a-Report-colHead" align="center" id="DATA_DEFAULT">Default</th><th class="a-Report-colHead" align="center" id="COMMENTS">Comment</th></tr></thead><tbody>
<tr><td class="a-Report-cell" headers="TABLE_NAME"><a href="javascript:ret_Column('WKSP_HARSHJTHAKAR.DEMO1');">DEMO1</a></td><td class="a-Report-cell" headers="COLUMN_NAME"><a href="javascript:ret_Column('STUDENT_ID');">STUDENT_ID</a></td><td class="a-Report-cell" headers="DATA_TYPE">NUMBER</td><td class="a-Report-cell" headers="DATA_LENGTH">22</td><td class="a-Report-cell" headers="DATA_PRECISION"> - </td><td class="a-Report-cell" headers="DATA_SCALE"> - </td><td class="a-Report-cell" align="center" headers="PK">1</td><td class="a-Report-cell" align="center" headers="NULLABLE"> - </td><td class="a-Report-cell" headers="DATA_DEFAULT"> - </td><td class="a-Report-cell" headers="COMMENTS"> - </td></tr>
<tr><td class="a-Report-cell" headers="TABLE_NAME"></td><td class="a-Report-cell" headers="COLUMN_NAME"><a href="javascript:ret_Column('NAME');">NAME</a></td><td class="a-Report-cell" headers="DATA_TYPE">VARCHAR2</td><td class="a-Report-cell" headers="DATA_LENGTH">50</td><td class="a-Report-cell" headers="DATA_PRECISION"> - </td><td class="a-Report-cell" headers="DATA_SCALE"> - </td><td class="a-Report-cell" align="center" headers="PK"> - </td><td class="a-Report-cell" align="center" headers="NULLABLE"><img src="INNER_JOIN._files/check_small_black.gif" border="0" height="15" width="15" alt="nullable"></td><td class="a-Report-cell" headers="DATA_DEFAULT"> - </td><td class="a-Report-cell" headers="COMMENTS"> - </td></tr>
      </tbody>
    </table>
    </div>
    <div class="a-Report-links"></div>
    <table class="a-Report-pagination a-Report-pagination a-Report-pagination--bottom" role="presentation"></table>
  </div>
</div></div></div><div id="historyHolder" style="display:none;"></div><div id="SavedSQLHolder" style="display:none;"></div><div id="sql-schema-select" style="display: none;"></div></div></div></div>
    </main>
  </div>
...
<script nonce="r6_BQzI3TkQRCQ8_WX9JMg">
var apex_img_dir = "https:\u002F\u002Fstatic.oracle.com\u002Fcdn\u002Fapex\u002F24.2.8\u002F";
var apex = {env: {DB_VERSION: 19,APP_USER: "HTHAKAR812@GMAIL.COM",APP_ID: "4500",APP_PAGE_ID: "1003",APP_SESSION: "101812520739103",APP_FILES: "r\u002Fapex\u002F4500\u002Ffiles\u002Fstatic\u002Fv1\u002F",WORKSPACE_FILES: "r\u002Fapex\u002Ffiles\u002Fstatic\u002Fv1\u002F",APEX_VERSION: "24.2.8",APEX_BASE_VERSION: "24.2",COMPATIBILITY_MODE: 24.2,NONCE: "r6_BQzI3TkQRCQ8_WX9JMg"},
...
<script nonce="r6_BQzI3TkQRCQ8_WX9JMg" src="INNER_JOIN._files/desktop_all.min.js"></script>
<script nonce="r6_BQzI3TkQRCQ8_WX9JMg" src="INNER_JOIN._files/wwv_flow.js_messages"></script>
<script nonce="r6_BQzI3TkQRCQ8_WX9JMg" src="INNER_JOIN._files/wwv_flow.js_dialogs"></script>
<script nonce="r6_BQzI3TkQRCQ8_WX9JMg" src="INNER_JOIN._files/legacy_pre18.min.js"></script>
<script nonce="r6_BQzI3TkQRCQ8_WX9JMg" src="INNER_JOIN._files/legacy_18.min.js"></script>
<script nonce="r6_BQzI3TkQRCQ8_WX9JMg" src="INNER_JOIN._files/builder_all.min.js"></script>
...
<script nonce="r6_BQzI3TkQRCQ8_WX9JMg" src="INNER_JOIN._files/sc_core.js"></script>
<script nonce="r6_BQzI3TkQRCQ8_WX9JMg">
...
<script nonce="r6_BQzI3TkQRCQ8_WX9JMg" src="INNER_JOIN._files/widget.splitter.min.js"></script>
<script nonce="r6_BQzI3TkQRCQ8_WX9JMg" src="INNER_JOIN._files/widget.toolbar.min.js"></script>

<script nonce="r6_BQzI3TkQRCQ8_WX9JMg" src="INNER_JOIN._files/require.js"></script>
<script nonce="r6_BQzI3TkQRCQ8_WX9JMg" src="INNER_JOIN._files/requirejs.jetConfig.min.js"></script>
<script nonce="r6_BQzI3TkQRCQ8_WX9JMg" src="INNER_JOIN._files/jetCommonBundle.min.js"></script>
<script nonce="r6_BQzI3TkQRCQ8_WX9JMg" src="INNER_JOIN._files/builder.plugin.codeEditor.min.js"></script>
<script nonce="r6_BQzI3TkQRCQ8_WX9JMg" src="INNER_JOIN._files/widget.codeEditor.min.js"></script>
<script nonce="r6_BQzI3TkQRCQ8_WX9JMg">
apex.session.initTimeouts(180,{"idle_time_ms":7185000,"life_time_ms":43185000,"max_idle_time_ms":7200000},'\u002Fords\u002Fr\u002Fapex\u002Fworkspace\u002Fhome','\u002Fords\u002Fr\u002Fapex\u002Fworkspace\u002Fhome');
