...
<script type="text/javascript" charset="utf-8" async="" data-requirecontext="_" data-requiremodule="vs/editor/editor.main" src="UNION%20AND%20UNION%20ALL_files/editor.main.js"></script><script type="text/javascript" charset="utf-8" async="" data-requirecontext="_" data-requiremodule="ojtranslations/nls/localeElements" src="UNION%20AND%20UNION%20ALL_files/localeElements.js"></script><script type="text/javascript" charset="utf-8" async="" data-requirecontext="_" data-requiremodule="ojtranslations/nls/en/localeElements" src="UNION%20AND%20UNION%20ALL_files/localeElements_002.js"></script><script type="text/javascript" charset="utf-8" async="" data-requirecontext="_" data-requiremodule="custom-languages/sql.min" src="UNION%20AND%20UNION%20ALL_files/sql.min.js"></script><!-- base href="https://oracleapex.com/ords/" -->
<link rel="stylesheet" href="UNION%20AND%20UNION%20ALL_files/Core.min_002.css" type="text/css">
<link rel="stylesheet" href="UNION%20AND%20UNION%20ALL_files/Theme-Standard.min.css" type="text/css">

<link rel="stylesheet" href="UNION%20AND%20UNION%20ALL_files/oraclesans-apex.min.css" type="text/css">


<link rel="stylesheet" href="UNION%20AND%20UNION%20ALL_files/Core.min.css" type="text/css">
<link rel="stylesheet" href="UNION%20AND%20UNION%20ALL_files/Theme-Dark.min.css" type="text/css">

<link rel="stylesheet" href="UNION%20AND%20UNION%20ALL_files/apex_builder.min.css" type="text/css">

<style nonce="EG1IwNw1LfqRvyMdLlD7uw">
#htmlTabHolder 
{
    overflow: auto; 
}
...
<style type="text/css">.LayerStyles_baseStyle__g9p4b90{position:relative}.LayerStyles_popupPriorityStyle__g9p4b91{z-index:1000}.LayerStyles_dialogPriorityStyle__g9p4b92{z-index:1050}.LayerStyles_messagesPriorityStyle__g9p4b93{z-index:2000}</style><script type="text/javascript" src="UNION%20AND%20UNION%20ALL_files/common.js" async="true" defer="true"></script><script type="text/javascript" src="UNION%20AND%20UNION%20ALL_files/analytics.js" async="true" defer="true"></script><link rel="stylesheet" type="text/css" data-name="vs/editor/editor.main" href="UNION%20AND%20UNION%20ALL_files/editor.main.css"><style type="text/css" media="screen" class="monaco-colors">.codicon-add:before { content: '\ea60'; }
...
<span id="APEX_SUCCESS_MESSAGE" data-template-id="690783685471803190_S" class="apex-page-success u-hidden"></span><span id="APEX_ERROR_MESSAGE" data-template-id="690783685471803190_E" class="apex-page-error u-hidden"></span><script src="UNION%20AND%20UNION%20ALL_files/odc.js"></script>
<script>
// Send Data
var cxDataObject = {
"apex.version":"24.2",
...
<span id="P1003_FIND_ICON" class="display_only apex-item-display-only"><a href="javascript:popupURL('f?p=4500:24:16562876087063:SC::24:P24_STATE:SC:');" class="a-Button a-Button--small a-Button--padLeft">Find Tables</a></span><input type="hidden" name="P1003_LANGUAGE" id="P1003_LANGUAGE" value="en"><input type="hidden" data-for="P1003_LANGUAGE" value="JS6Ii6OqiDJP5LP9yZrMqV-VBpy30ekD8QxXI5uvwnGXq7hWIAjdvmkB4XKIqUu8e_xcgrMCaLp5AVVyNw0jjA">
</div>
</div>
</div>
...
</div><div class="a-Form-inputContainer"><div id="P1003_SQL_COMMAND1_widget" style="height: 100%;" class="a-MonacoEditor is-active"><textarea id="P1003_SQL_COMMAND1" name="P1003_SQL_COMMAND1" rows="5" class="a-Form-textarea--code" style="display: none;">//UNIION 

CREATE TABLE DEMO1(
STUDENT_ID NUMBER PRIMARY KEY,
STUDENT_NAME VARCHAR(50)
);
INSERT INTO DEMO1 VALUES(101,'HARSH');
INSERT INTO DEMO1 VALUES(102,'THAKAR');

CREATE TABLE DEMO2(
EMPLOYEE_ID NUMBER PRIMARY KEY,
EMPLOYEE_NAME VARCHAR(50) 
);
INSERT INTO DEMO2 VALUES(101,'RANDOM ONE');
INSERT INTO DEMO2 VALUES(103,'RANDOM TWO');

SELECT STUDENT_ID FROM DEMO1
UNION 
SELECT EMPLOYEE_ID FROM DEMO2;

//UNION ALL
SELECT STUDENT_ID FROM DEMO1
UNION ALL
SELECT EMPLOYEE_ID FROM DEMO2;</textarea><div class="a-MonacoEditorContent">
                    <div class="a-MonacoEditorContent-left">
                        ...
                        <div class="a-MonacoEditor-editor" dir="ltr" data-keybinding-context="1" data-mode-id="sql" style="--vscode-editorCodeLens-lineHeight: 26px; --vscode-editorCodeLens-fontSize: 20px; --vscode-editorCodeLens-fontFeatureSettings: &quot;liga&quot; off, &quot;calt&quot; off;"><div class="monaco-editor no-user-select  showUnused showDeprecated vs-dark focused" role="code" style="width: 1918px; height: 475px;" data-uri="inmemory://model/1"><div data-mprt="3" class="overflow-guard" style="width: 1918px; height: 475px;"><div class="margin" style="position: absolute; transform: translate3d(0px, 0px, 0px); contain: strict; top: -300px; height: 1165px; width: 75px;" role="presentation" aria-hidden="true"><div class="glyph-margin" style="left: 0px; width: 0px; height: 1165px;"></div><div class="margin-view-zones" style="position: absolute;" role="presentation" aria-hidden="true"></div><div class="margin-view-overlays focused" style="position: absolute; font-family: Consolas, &quot;Courier New&quot;, monospace; font-weight: normal; font-size: 22.4px; font-feature-settings: &quot;liga&quot; 0, &quot;calt&quot; 0; font-variation-settings: normal; line-height: 30px; letter-spacing: 0px; width: 75px; height: 1165px;" role="presentation" aria-hidden="true"><div style="top:540px;height:30px;"><div class="line-numbers" style="left:0px;width:49px;">19</div></div><div style="top:570px;height:30px;"><div class="line-numbers" style="left:0px;width:49px;">20</div></div><div style="top:600px;height:30px;"><div class="current-line current-line-margin-both" style="width:75px"></div><div class="line-numbers active-line-number" style="left:0px;width:49px;">21</div></div><div style="top:630px;height:30px;"><div class="line-numbers" style="left:0px;width:49px;">22</div></div><div style="top:660px;height:30px;"><div class="line-numbers" style="left:0px;width:49px;">23</div></div><div style="top:690px;height:30px;"><div class="line-numbers" style="left:0px;width:49px;">24</div></div><div style="top:480px;height:30px;"><div class="line-numbers" style="left:0px;width:49px;">17</div></div><div style="top:510px;height:30px;"><div class="line-numbers" style="left:0px;width:49px;">18</div></div><div style="top:450px;height:30px;"><div class="line-numbers" style="left:0px;width:49px;">16</div></div><div style="top:390px;height:30px;"><div class="line-numbers" style="left:0px;width:49px;">14</div></div><div style="top:420px;height:30px;"><div class="line-numbers" style="left:0px;width:49px;">15</div></div><div style="top:330px;height:30px;"><div class="line-numbers" style="left:0px;width:49px;">12</div></div><div style="top:360px;height:30px;"><div class="line-numbers" style="left:0px;width:49px;">13</div></div><div style="top:300px;height:30px;"><div class="line-numbers" style="left:0px;width:49px;">11</div></div></div><div class="glyph-margin-widgets" style="position: absolute; top: 0px;"></div></div><div class="monaco-scrollable-element editor-scrollable vs-dark" role="presentation" style="position: absolute; overflow: hidden; left: 75px; width: 1843px; height: 475px;" data-mprt="6"><div class="lines-content monaco-editor-background" style="position: absolute; overflow: hidden; width: 16777200px; height: 16777200px; transform: translate3d(0px, 0px, 0px); contain: strict; top: -300px; left: 0px;"><div class="view-overlays focused" style="position: absolute; font-family: Consolas, &quot;Courier New&quot;, monospace; font-weight: normal; font-size: 22.4px; font-feature-settings: &quot;liga&quot; 0, &quot;calt&quot; 0; font-variation-settings: normal; line-height: 30px; letter-spacing: 0px; height: 0px; width: 1843px;" role="presentation" aria-hidden="true"><div style="top:540px;height:30px;"></div><div style="top:570px;height:30px;"></div><div style="top:600px;height:30px;"><div class="current-line current-line-exact" style="width:1843px;"></div><div class="cdr wordHighlightText" style="left:99px;width:36px;"></div></div><div style="top:630px;height:30px;"></div><div style="top:660px;height:30px;"><div class="cdr wordHighlightText" style="left:74px;width:37px;"></div></div><div style="top:690px;height:30px;"></div><div style="top:480px;height:30px;"></div><div style="top:510px;height:30px;"></div><div style="top:450px;height:30px;"></div><div style="top:390px;height:30px;"></div><div style="top:420px;height:30px;"></div><div style="top:330px;height:30px;"></div><div style="top:360px;height:30px;"></div><div style="top:300px;height:30px;"></div></div><div role="presentation" aria-hidden="true" class="view-rulers"></div><div class="view-zones" style="position: absolute;" role="presentation" aria-hidden="true"></div><div class="view-lines monaco-mouse-cursor-text" style="position: absolute; font-family: Consolas, &quot;Courier New&quot;, monospace; font-weight: normal; font-size: 22.4px; font-feature-settings: &quot;liga&quot; 0, &quot;calt&quot; 0; font-variation-settings: normal; line-height: 30px; letter-spacing: 0px; width: 1843px; height: 1165px;" role="presentation" aria-hidden="true" data-mprt="8"><div style="top:540px;height:30px;" class="view-line"><span><span class="mtk15">SELECT</span><span class="mtk1">&nbsp;EMPLOYEE_ID&nbsp;</span><span class="mtk15">FROM</span><span class="mtk1">&nbsp;DEMO2</span><span class="mtk10">;</span></span></div><div style="top:570px;height:30px;" class="view-line"><span><span></span></span></div><div style="top:600px;height:30px;" class="view-line"><span><span class="mtk1">//</span><span class="mtk15">UNION</span><span class="mtk1">&nbsp;</span><span class="mtk15">ALL</span></span></div><div style="top:630px;height:30px;" class="view-line"><span><span class="mtk15">SELECT</span><span class="mtk1">&nbsp;STUDENT_ID&nbsp;</span><span class="mtk15">FROM</span><span class="mtk1">&nbsp;DEMO1</span></span></div><div style="top:660px;height:30px;" class="view-line"><span><span class="mtk15">UNION</span><span class="mtk1">&nbsp;</span><span class="mtk15">ALL</span></span></div><div style="top:690px;height:30px;" class="view-line"><span><span class="mtk15">SELECT</span><span class="mtk1">&nbsp;EMPLOYEE_ID&nbsp;</span><span class="mtk15">FROM</span><span class="mtk1">&nbsp;DEMO2</span><span class="mtk10">;</span></span></div><div style="top:480px;height:30px;" class="view-line"><span><span class="mtk15">SELECT</span><span class="mtk1">&nbsp;STUDENT_ID&nbsp;</span><span class="mtk15">FROM</span><span class="mtk1">&nbsp;DEMO1</span></span></div><div style="top:510px;height:30px;" class="view-line"><span><span class="mtk15">UNION</span><span class="mtk1">&nbsp;</span></span></div><div style="top:450px;height:30px;" class="view-line"><span><span></span></span></div><div style="top:390px;height:30px;" class="view-line"><span><span class="mtk15">INSERT</span><span class="mtk1">&nbsp;</span><span class="mtk15">INTO</span><span class="mtk1">&nbsp;DEMO2&nbsp;</span><span class="mtk15">VALUES</span><span class="mtk10">(</span><span class="mtk7">101</span><span class="mtk10">,</span><span class="mtk16">'RANDOM&nbsp;ONE'</span><span class="mtk10">);</span></span></div><div style="top:420px;height:30px;" class="view-line"><span><span class="mtk15">INSERT</span><span class="mtk1">&nbsp;</span><span class="mtk15">INTO</span><span class="mtk1">&nbsp;DEMO2&nbsp;</span><span class="mtk15">VALUES</span><span class="mtk10">(</span><span class="mtk7">103</span><span class="mtk10">,</span><span class="mtk16">'RANDOM&nbsp;TWO'</span><span class="mtk10">);</span></span></div><div style="top:330px;height:30px;" class="view-line"><span><span class="mtk1">EMPLOYEE_NAME&nbsp;</span><span class="mtk24">VARCHAR</span><span class="mtk10">(</span><span class="mtk7">50</span><span class="mtk10">)</span><span class="mtk1">&nbsp;</span></span></div><div style="top:360px;height:30px;" class="view-line"><span><span class="mtk10">);</span></span></div><div style="top:300px;height:30px;" class="view-line"><span><span class="mtk1">EMPLOYEE_ID&nbsp;</span><span class="mtk24">NUMBER</span><span class="mtk1">&nbsp;</span><span class="mtk15">PRIMARY</span><span class="mtk1">&nbsp;</span><span class="mtk15">KEY</span><span class="mtk10">,</span></span></div></div><div data-mprt="1" class="contentWidgets" style="position: absolute; top: 0px;"></div><div role="presentation" aria-hidden="true" class="cursors-layer cursor-line-style cursor-solid"><div class="cursor  monaco-mouse-cursor-text " style="height: 30px; top: 600px; left: 134px; font-family: Consolas, &quot;Courier New&quot;, monospace; font-weight: normal; font-size: 22.4px; font-feature-settings: &quot;liga&quot; 0, &quot;calt&quot; 0; font-variation-settings: normal; line-height: 30px; letter-spacing: 0px; display: block; visibility: inherit; padding-left: 1px; width: 2px;"></div></div></div><div role="presentation" aria-hidden="true" class="invisible scrollbar horizontal" style="position: absolute; width: 1829px; height: 12px; left: 0px; bottom: 0px;"><div class="slider" style="position: absolute; top: 0px; left: 0px; height: 12px; transform: translate3d(0px, 0px, 0px); contain: strict; width: 1829px;"></div></div><canvas class="decorationsOverviewRuler" style="position: absolute; transform: translate3d(0px, 0px, 0px); contain: strict; top: 0px; right: 0px; width: 14px; height: 475px; display: block;" aria-hidden="true" width="14" height="475"></canvas><div role="presentation" aria-hidden="true" class="invisible scrollbar vertical fade" style="position: absolute; width: 14px; height: 475px; right: 0px; top: 0px;"><div class="slider" style="position: absolute; top: 123px; left: 0px; width: 14px; transform: translate3d(0px, 0px, 0px); contain: strict; height: 193px;"></div></div></div><div role="presentation" aria-hidden="true" style="width: 1918px;" class="scroll-decoration"></div><textarea data-mprt="7" class="inputarea monaco-mouse-cursor-text" wrap="off" style="tab-size: 49.2656px; font-family: Consolas, &quot;Courier New&quot;, monospace; font-weight: normal; font-size: 22.4px; font-feature-settings: &quot;liga&quot; 0, &quot;calt&quot; 0; font-variation-settings: normal; line-height: 30px; letter-spacing: 0px; top: 300px; left: 210px; width: 0px; height: 30px;" autocorrect="off" autocapitalize="none" autocomplete="off" spellcheck="false" aria-label="SQL Command" aria-required="false" tabindex="0" role="textbox" aria-roledescription="editor" aria-multiline="true" aria-autocomplete="both" aria-readonly="false">//UNIION 
...
<td width="100%"><br></td></tr></tbody></table><div id="htmlTabHolder" class="resize" style="height: 216px; width: 1920px;"><div id="resultsHolder" class="fielddata"><div id="BOX_BODY"><div id="R11140505307196687" class=""><input type="hidden" name="OB_OBJECT_NAME" id="OB_OBJECT_NAME" value=""><input type="hidden" name="P0_PPRTIMESTAMP" id="P0_PPRTIMESTAMP" value=""></div><input type="hidden" name="P1200_ROWS" id="P1200_ROWS" value="3"><input type="hidden" name="P1200_PREV_SQL" id="P1200_PREV_SQL" value="SELECT STUDENT_ID FROM DEMO1
UNION ALL
SELECT EMPLOYEE_ID FROM DEMO2;"><input type="hidden" name="P1200_ACTION" id="P1200_ACTION" value=""><input type="hidden" name="P1200_BINDS" id="P1200_BINDS" value=""><input type="hidden" name="P1200_BIND_VALS" id="P1200_BIND_VALS" value=""><input type="hidden" name="P1200_TYPE" id="P1200_TYPE" value=""><input type="hidden" name="P1200_STMT" id="P1200_STMT" value=""><div id="ResultsSQL">
<table aria-label="Results" cellpadding="0" cellspacing="0" border="0" class="u-Report u-Report--stretch">
<tbody><tr><th id="STUDENT_ID">STUDENT_ID</th></tr>
<tr><td headers="STUDENT_ID">101</td></tr>
<tr><td headers="STUDENT_ID">102</td></tr>
<tr><td headers="STUDENT_ID">101</td></tr>
<tr><td headers="STUDENT_ID">103</td></tr>
</tbody></table>
</div>
<table><tbody><tr><td><span style="font-size:13px">4 rows returned in                0.01 seconds</span></td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><span style="font-size:11px"><a href="https://oracleapex.com/ords/f?p=4500:1204:16562876087063::::P1204_BROWSER_LANG:en">Download</a></span></td></tr></tbody></table><div class="hide-show-region" id="dbms_output_show_hide" style="display:none;">
  <div class="hide-show-top">
    <div class="hide-show-title"><h3 data-apex-heading="">
      <a href="#" onclick="htmldb_ToggleTableBody('idbms_output_show_hide','bodydbms_output_show_hide'); return false;">
        <img src="UNION%20AND%20UNION%20ALL_files/rollup_plus_dgray.gif" class="pseudoButtonActive" id="idbms_output_show_hide" alt="">
        DBMS Output
      </a></h3>    
    </div>
  </div>
...
<script nonce="EG1IwNw1LfqRvyMdLlD7uw">
var apex_img_dir = "https:\u002F\u002Fstatic.oracle.com\u002Fcdn\u002Fapex\u002F24.2.8\u002F";
var apex = {env: {DB_VERSION: 19,APP_USER: "HTHAKAR812@GMAIL.COM",APP_ID: "4500",APP_PAGE_ID: "1003",APP_SESSION: "16562876087063",APP_FILES: "r\u002Fapex\u002F4500\u002Ffiles\u002Fstatic\u002Fv1\u002F",WORKSPACE_FILES: "r\u002Fapex\u002Ffiles\u002Fstatic\u002Fv1\u002F",APEX_VERSION: "24.2.8",APEX_BASE_VERSION: "24.2",COMPATIBILITY_MODE: 24.2,NONCE: "EG1IwNw1LfqRvyMdLlD7uw"},
...
<script nonce="EG1IwNw1LfqRvyMdLlD7uw" src="UNION%20AND%20UNION%20ALL_files/desktop_all.min.js"></script>
<script nonce="EG1IwNw1LfqRvyMdLlD7uw" src="UNION%20AND%20UNION%20ALL_files/wwv_flow.js_messages"></script>
<script nonce="EG1IwNw1LfqRvyMdLlD7uw" src="UNION%20AND%20UNION%20ALL_files/wwv_flow.js_dialogs"></script>
<script nonce="EG1IwNw1LfqRvyMdLlD7uw" src="UNION%20AND%20UNION%20ALL_files/legacy_pre18.min.js"></script>
<script nonce="EG1IwNw1LfqRvyMdLlD7uw" src="UNION%20AND%20UNION%20ALL_files/legacy_18.min.js"></script>
<script nonce="EG1IwNw1LfqRvyMdLlD7uw" src="UNION%20AND%20UNION%20ALL_files/builder_all.min.js"></script>
...
setTimeout(function() {
    sc_getResults('16562876087063', true);
},100);
...
<script nonce="EG1IwNw1LfqRvyMdLlD7uw" src="UNION%20AND%20UNION%20ALL_files/sc_core.js"></script>
<script nonce="EG1IwNw1LfqRvyMdLlD7uw">
...
<script nonce="EG1IwNw1LfqRvyMdLlD7uw" src="UNION%20AND%20UNION%20ALL_files/widget.splitter.min.js"></script>
<script nonce="EG1IwNw1LfqRvyMdLlD7uw" src="UNION%20AND%20UNION%20ALL_files/widget.toolbar.min.js"></script>

<script nonce="EG1IwNw1LfqRvyMdLlD7uw" src="UNION%20AND%20UNION%20ALL_files/require.js"></script>
<script nonce="EG1IwNw1LfqRvyMdLlD7uw" src="UNION%20AND%20UNION%20ALL_files/requirejs.jetConfig.min.js"></script>
<script nonce="EG1IwNw1LfqRvyMdLlD7uw" src="UNION%20AND%20UNION%20ALL_files/jetCommonBundle.min.js"></script>
<script nonce="EG1IwNw1LfqRvyMdLlD7uw" src="UNION%20AND%20UNION%20ALL_files/builder.plugin.codeEditor.min.js"></script>
<script nonce="EG1IwNw1LfqRvyMdLlD7uw" src="UNION%20AND%20UNION%20ALL_files/widget.codeEditor.min.js"></script>
<script nonce="EG1IwNw1LfqRvyMdLlD7uw">
apex.session.initTimeouts(180,{"idle_time_ms":7190000,"life_time_ms":43008000,"max_idle_time_ms":7200000},'\u002Fords\u002Fr\u002Fapex\u002Fworkspace\u002Fhome','\u002Fords\u002Fr\u002Fapex\u002Fworkspace\u002Fhome');
...
(function(){apex.widget.selectList("#P1003_SCHEMA",{"ajaxIdentifier":"SVRFTSBUWVBFfjUxMjB-MTE3NjU4MDQyNDYwMDc1NDc\u002Fr0gvkQJcqoDsshGdEFcqLS9Yp_NUF_o-Ud150gjO691kNfzeHKef522CbeI8MN9FgENiFBc_22WlBl0FcsyaBg"});})();
...
apex.server.plugin('UkVHSU9OIFRZUEV-fjExNTc2ODYzODY1ODIzMzgyMjQ\u002F5TXCJyq2x-hqoRhHH9w4dbpztbjRWJY6VDOsDjK43viY_RhO36GDZI5GnJIhUp2KTdB9Yq8I1_CYr0AeT1vAsA', {
...
(function(){apex.widget.selectList("#P1003_ROWS",{"ajaxIdentifier":"SVRFTSBUWVBFfjUxMjB-MTM4OTQwMjI2NTk0NTcxNTg4\u002F-CPe8Fzto77FaG9zra_RfYVqNKtTt-pWjswKYI0UBSKpGoPLHT2HWQucrlyYXZu6QoCT_EV8GnfdWzxP6wZq6Q"});})();
...
,"readOnly":false
,"ajaxIdentifier":"SVRFTSBUWVBFfjUxMjB-MTAxMDQwNDY0MjE2MzAzOQ\/igZmETTXZ4uM1fy9aQGS4U7Iui5fn3UvGV2IsyNQmSTTIjgSpwP3F2rNhBOXGjS7XyO88uSupETxCRod--Ao8A"
